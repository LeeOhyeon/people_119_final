...
<script
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container">
        <h3>면접 경험 수정</h3>
        <p>등록된 이력서의 입사 경력을 불러옵니다. 수정해주신 면접후기는 <strong>익명</strong>으로 등록됩니다.</p>
        <div class="normal-info">
          <h5><strong>기본정보입력</strong></h5>
          <form action="${path}/interview/interviewUpdate.do" onsubmit="return submitChk();">
            ...
            <div class="duty">
              ...
              <div>
                <input type="text" class="form-control" name="interviewReviewNo" value="<%=request.getParameter("interviewReviewNo")%>" style="display:none;">
              </div>           
              <div>

...
public class PageFactoryBoardComment {
	...
	public static String getPageBar(int totalData, int cPage, int numPerpage, int pageBarSize) {
		...
		if(pageNo == 1) {
	        ...
	        pageBar += "<a class='page-link' href='javascript:commentsort("+(pageNo-1)+")'> < </a>";
	        pageBar += "</li>";
		...
		while(!(pageNo > pageEnd || pageNo > totalPage)) {
			if(cPage == pageNo) {
	           ...
	           pageBar += "<li class='page-item'>";
	           pageBar += "<a class='page-link' href='javascript:commentsort("+(pageNo)+")'>"+pageNo+"</a>";
	           pageBar += "</li>";
			}
			pageNo++;
		}
		...
		if(pageNo > totalPage) {
	        ...
	        pageBar += "<li class='page-item'>";
	        pageBar += "<a class='page-link' href='javascript:commentsort("+(pageNo)+")'> > </a>";
	        pageBar += "</li>";
		}
		pageBar += "</ul>";
		/*
